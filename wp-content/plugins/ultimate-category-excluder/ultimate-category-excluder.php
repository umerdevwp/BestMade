...
function ksuce_admin_menu() {
	add_options_page( __( 'Category Excluder Options', 'UCE'), __( 'Category Excluder', 'UCE' ), "manage_options", basename(__FILE__), 'ksuce_options_page' );
}
...
function ksuce_options_page() {
	...
	?>
	<div class="wrap">
		<h2><?php _e( 'Category Excluder Options', 'UCE' ); ?></h2>
	...
	<p class="submit"><input type="submit" class="button-primary" value="<?php _e('Update', 'UCE'); ?>" /></p>
